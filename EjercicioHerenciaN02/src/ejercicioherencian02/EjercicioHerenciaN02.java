 ...
 * vacío.
 *
 * • Un constructor con todos los atributos pasados por parámetro. Los métodos a
 * implementar son:
 *
 ...
 * valor del precio. Esta es la lista de precios: A continuación, se debe crear
 * una subclase llamada Lavadora, con el atributo carga, además de los atributos
 * heredados. Los constructores que se implementarán serán:
 *
 ...
 * padre. LETRA PRECIO A $1000 B $800 C $600 D $500 E $300 F $100 PESO PRECIO
 * Entre 1 y 19 kg $100 Entre 20 y 49 kg $500 Entre 50 y 79 kg $800 Mayor que 80
 * kg $1000 14 Los métodos que se implementara serán:
 *
 ...
 */
public class EjercicioHerenciaN02 {
